...
const MainLayout = () => {
  return (
    <>
      ...
      <Outlet />
      <ToastContainer  /> 
       {/* When ToastContainer is placed inside MainLayout, it persists across all pages, just like the navbar. This ensures that any toast triggered from any page inside Outlet will be displayed. */}
    </>
  );
};
