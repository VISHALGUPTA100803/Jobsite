...
✅ Better Code Structure – Helps separate main content from secondary content. */}
              ...
              <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                ...
                <button onClick={() => onD} className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block">
                  Delete Job
                </button>
              </div>
            </aside>
