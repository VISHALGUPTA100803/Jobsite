...
const App = () => {
  return (
    <>
        <nav ="bg-indigo-700 border-b border-indigo-500">
    ...
    {/* <!-- Hero --> */}
    <section ="bg-indigo-700 py-20 mb-4">
      <div
        ="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center"
      >
        <div ="text-center">
          <h1
    ...
    <section ="py-4">
      <div ="container-xl lg:container m-auto">
        <div ="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg">
          <div ="bg-gray-100 p-6 rounded-lg shadow-md">
            <h2 ="text-2xl font-bold">For Developers</h2>
            <p ="mt-2 mb-4">
          ...
          <div ="bg-indigo-100 p-6 rounded-lg shadow-md">
            <h2 ="text-2xl font-bold">For Employers</h2>
            <p ="mt-2 mb-4">
    ...
    {/* <!-- Browse Jobs --> */}
    <section ="bg-blue-50 px-4 py-10">
      <div ="container-xl lg:container m-auto">
        <h2 ="text-3xl font-bold text-indigo-500 mb-6 text-center">
          Browse Jobs
        </h2>
        <div ="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* <!-- Job Listing 1 --> */}
          <div ="bg-white rounded-xl shadow-md relative">
            <div ="p-4">
              <div ="mb-6">
                <div ="text-gray-600 my-2">Full-Time</div>
                <h3 ="text-xl font-bold">Senior React Developer</h3>
              </div>
              ...
              <h3 ="text-indigo-500 mb-2">$70 - $80K / Year</h3>

              <div ="border border-gray-100 mb-5"></div>

              <div ="flex flex-col lg:flex-row justify-between mb-4">
                <div ="text-orange-700 mb-3">
                  <i ="fa-solid fa-location-dot text-lg"></i>
                  Boston, MA
                </div>
                <a
                  href="job.html"
          ...
          <div ="bg-white rounded-xl shadow-md relative">
            <div ="p-4">
              <div ="mb-6">
                <div ="text-gray-600 my-2">Remote</div>
                <h3 ="text-xl font-bold">Front-End Engineer (React)</h3>
              </div>
              ...
              <h3 ="text-indigo-500 mb-2">$70K - $80K / Year</h3>
          ...
          <div ="bg-white rounded-xl shadow-md relative">
            <div ="p-4">
              <div ="mb-6">
                <div ="text-gray-600 my-2">Remote</div>
                <h3 ="text-xl font-bold">React.js Developer</h3>
              </div>
    ...
    <section ="m-auto max-w-lg my-10 px-6">
      <a
        href="jobs.html"
